...
func TestTwoQuery(t *testing.T) {
	...
	a.GetFilterQuerySQL()
	expectConditionSQL := " company_id in ( select id from company where code = ? ) "
	expectValueSQL := "test"
...
func TestThreeQuery(t *testing.T) {
	...
	a.GetFilterQuerySQL()
	expectConditionSQL := " costcenter_id in ( select id from costcenter where company_id in ( select id from company where code = ? ) ) "
	expectValueSQL := "test"
...
func TestFourQuery(t *testing.T) {
	...
	a.GetFilterQuerySQL()
	expectConditionSQL := " asset_id in ( select id from asset where costcenter_id in ( select id from costcenter where company_id in ( select id from company where code = ? ) ) ) "
	expectValueSQL := "test"
...
func TestFourIlike(t *testing.T) {
	...
	a.GetFilterQuerySQL()
	expectConditionSQL := " asset_id in ( select id from asset where costcenter_id in ( select id from costcenter where company_id in ( select id from company where code ilike ? ) ) ) "
	expectValueSQL := "%test%"
...
func TestFourIn(t *testing.T) {
	...
	a.GetFilterQuerySQL()
	expectConditionSQL := " asset_id in ( select id from asset where costcenter_id in ( select id from costcenter where company_id in ( select id from company where code in (?) ) ) ) "
...
func TestFourStart(t *testing.T) {
	...
	a.GetFilterQuerySQL()
	expectConditionSQL := " asset_id in ( select id from asset where costcenter_id in ( select id from costcenter where company_id in ( select id from company where create_time >= ? ) ) ) "
...
func TestFourIsNullFalse(t *testing.T) {
	...
	a.GetFilterQuerySQL()
	expectConditionSQL := " asset_id in ( select id from asset where costcenter_id in ( select id from costcenter where company_id in ( select id from company where create_time is not null ) ) ) "
	// expectValueSQL := nil
...
func TestFourIsNullTrue(t *testing.T) {
	...
	a.GetFilterQuerySQL()
	expectConditionSQL := " asset_id in ( select id from asset where costcenter_id in ( select id from costcenter where company_id in ( select id from company where create_time is null ) ) ) "
	// expectValueSQL := nil
...
func TestFourIsEmptyTrue(t *testing.T) {
	...
	a.GetFilterQuerySQL()
	expectConditionSQL := " asset_id in ( select id from asset where costcenter_id in ( select id from costcenter where company_id in ( select id from company where (COALESCE(\"create_time\"::varchar ,'') = '' ) ) ) ) "
	// expectValueSQL := nil
...
func TestFourLT(t *testing.T) {
	...
	a.GetFilterQuerySQL()
	expectConditionSQL := " asset_id in ( select id from asset where costcenter_id in ( select id from costcenter where company_id in ( select id from company where qty < ? ) ) ) "
	expectValueSQL := "50"
